<x-book-layout>
    ...
    <style>
        .book-table {
            border-collapse: collapse; /* Để các viền nhập làm một */
            border: 2px solid #333;    /* Viền ngoài cùng của bảng */
        }
        .book-table th, .book-table td {
            border: 1px solid #333;    /* Viền của từng ô bên trong */
            padding: 8px;
        }
        .book-table thead th {
            background-color: #f8f9fa;
            border-bottom: 2px solid #333; /* Viền ngăn cách giữa tiêu đề và nội dung đậm hơn */
        }
    </style>
